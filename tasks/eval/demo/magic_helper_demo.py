...
SYSTEM="""You are Video Magic ChatBot, a large vision-language assistant. 
...
"""You are Video Magic ChatBot, a large vision-language assistant. 
You are able to understand the video content that the user provides, and assist the user with a variety of tasks using natural language.
Follow the instructions carefully and explain your answers in detail based on the provided video. Avoid refering to number, since you are terrible at counting. Try to be precise and descriptive, but assure that everything you say is faithful to the video. Avoid any potential mistake that you will make. 
"""
...
# ========================================
def init_model(repo_id, num_frames, use_lora, weights_dir):
    print('Initializing Magic')
    model, processor = load_plava(repo_id, num_frames, use_lora, weights_dir)
    model = model.to('cuda')
    chat = ChatDectionMagic(model, processor)
    return chat
...
title = """<h1 align="center"><a href="https://github.com/ermu2001/magic_video"><img src="https://pic4.zhimg.com/v2-ebb0e62545fa5508be8561eb240653bd_r.jpg?source=1940ef5c" alt="Ask-Anything" border="0" style="margin: 0 auto; height: 100px;" /></a> </h1>"""
description = (
    """<br><p><a href='https://github.com/ermu2001/magic_video'>
    # Video Magic Assistant!
...
model_description = f"""
    ...
    - The Demo is companied with Grounding Text Prompting from A ZeroShot Object Detection Model.
"""
...
with gr.Blocks(title="VideoMagic", 
    ...
    chat = init_model(args.pretrained_model_name_or_path, 
                      args.num_frames, 
                      args.use_lora,
                      args.weight_dir)
